...
<script lang="ts">
  ...
  // Função para simular dados enquanto o backend não está disponível
  const simulateDashboardData = () => {
    stats = {
      ...
      totalCustomers: 87,
      recentOrders: [
        { id: "ORD-2023-001", customer: "José Silva", total: 48.90, date: "2025-05-12", status: "delivered" },
        { id: "ORD-2023-002", customer: "Maria Oliveira", total: 32.50, date: "2025-05-12", status: "processing" },
        { id: "ORD-2023-003", customer: "João Pereira", total: 75.20, date: "2025-05-11", status: "pending" },
        { id: "ORD-2023-004", customer: "Ana Santos", total: 19.80, date: "2025-05-11", status: "delivered" },
        { id: "ORD-2023-005", customer: "Carlos Lima", total: 54.60, date: "2025-05-10", status: "canceled" }
      ],
      topProducts: [
        { name: "Pão Francês", sales: 243, revenue: 729.00 },
        { name: "Café Especial", sales: 187, revenue: 1122.00 },
        { name: "Bolo de Chocolate", sales: 132, revenue: 2640.00 },
        { name: "Croissant", sales: 116, revenue: 812.00 },
        { name: "Cookie de Baunilha", sales: 98, revenue: 392.00 }
      ]
    };
  };
...
<style>
  ...
  .shortcuts h2, .recent-section h2, .top-section h2 {
    font-size: 1.4rem;
    margin-bottom: 1rem;
    color: #333;
